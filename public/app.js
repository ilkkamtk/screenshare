...
const config = {
  ...
  onRoomFound: function(room) {
    ...
    document.querySelector(
        '.hide-after-join').innerHTML = '<img src="https://www.webrtc-experiment.com/images/key-press.gif" style="margint-top:10px; width:50%;" />';
  },
...
function rotateVideo(video) {
  video.style[navigator.mozGetUserMedia ?
      'transform' :
...
function showPrivateLink() {
  ...
  uniqueToken.innerHTML = '<a href="' + location.href +
